...
protocol ChatViewControllerDelegate {
   ...
   */
  func chatController(_ chatController: ZendeskChatManagerObject, didSelectImage image: UIImage)
   ...
   */
  func chatController(_ chatController: ZendeskChatManagerObject, sendMessage message: String)
}
